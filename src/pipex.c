...
/*   Updated: 2023/06/02 12:57:19 by rmarceau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/pipex.h"

static void	ft_parsing_pipex(t_data *pipex_data, int argc, char **argv,
		char **envp)
{
	if (argc != 5)
	...
	if (!pipex_data->infile || !pipex_data->outfile || !pipex_data->cmd1
		|| !pipex_data->cmd2 || !pipex_data->envp)
	...
	pipex_data->fd_outfile = open(argv[argc - 1], O_RDWR | O_CREAT | O_TRUNC,
			0644);
