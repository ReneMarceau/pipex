...
/*   Updated: 2023/05/22 05:25:24 by rene             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (ft_strncmp(error_message, ERR_INPUT, ft_strlen(error_message)) == 0 || ft_strncmp(error_message, ERR_MALLOC, ft_strlen(error_message)) == 0)
        ft_putendl_fd(error_message, STDERR_FILENO);
    else if (ft_strncmp(error_message, ERR_INFILE, ft_strlen(error_message)) == 0)
        perror(pipex_data->infile);
    else if (ft_strncmp(error_message, ERR_OUTFILE, ft_strlen(error_message)) == 0)
